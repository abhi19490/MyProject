...
(function() {
  ...
  sliderDirective = function($timeout) {
    return {
      ...
      template: '<span class="bar"></span><span class="bar selection"></span><span class="pointer"></span><span class="pointer"></span><span class="bubble selection"></span><span ng-bind-html-unsafe="translate({value: floor})" class="bubble limit">Year: {{floor}}</span><span ng-bind-html-unsafe="translate({value: ceiling})" class="bubble limit">Year: {{ceiling}}</span><span class="bubble">Year: {{ngModel}}</span><span class="bubble"></span><span class="bubble"></span>',
